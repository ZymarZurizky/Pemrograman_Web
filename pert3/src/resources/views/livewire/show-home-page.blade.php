        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="block text-center text-lg-start pe-0 pe-xl-5">
              <h1 class="text-capitalize mb-4">{{ $page_config->title ?? '' }}</h1>
              <p class="mb-4">{{ $page_config->detail ?? '' }}</p> <a type="button"
            ...
            <div class="ps-lg-5 text-center">
              ...
              src="{{ asset('storage/' . $page_config->image ?? '') }}"
              alt="banner image" class="img-fluid" style="max-width: 80%; height: auto;">
            </div>
            </div>
        </div>
      </div>
